...
use crate::{
    encode_vec, BlockType, Catch, DataIdx, ElemIdx, Encode, FieldIdx, FuncIdx, GlobalIdx, Handle,
    HeapType, LabelIdx, Lane, LocalIdx, MemArg, MemIdx, Ordering, RefType, TableIdx, TagIdx,
    TypeIdx, ValType,
};
use alloc::vec::Vec;
